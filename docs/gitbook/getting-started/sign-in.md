...
Signing in asks only for your basic profile: your name and email address, together with the IDs of your account and your organization. It reads nothing in your organization's Microsoft 365 and normally needs no administrator rights. If Microsoft shows **Need admin approval**, your organization reviews every new app first: ask an administrator to approve the LicenseMeter sign-in, which covers the basic profile only. Connecting Microsoft 365 for the license data is a separate, later step: a second Microsoft dialog for a separate app, LicenseMeter Connector, that an administrator approves.
